...
*ImageOpenshiftIoV1Api* | [**read_namespaced_image_stream_secrets**](docs/ImageOpenshiftIoV1Api.md#read_namespaced_image_stream_secrets) | **GET** /apis/image.openshift.io/v1/namespaces/{namespace}/imagestreams/{name}/secrets | 
...
*OapiApi* | [**connect_post_namespaced_build_config_instantiatebinary**](docs/OapiApi.md#connect_post_namespaced_build_config_instantiatebinary) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs/{name}/instantiatebinary | 
*OapiApi* | [**connect_post_namespaced_build_config_webhooks**](docs/OapiApi.md#connect_post_namespaced_build_config_webhooks) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks | 
*OapiApi* | [**connect_post_namespaced_build_config_webhooks_with_path**](docs/OapiApi.md#connect_post_namespaced_build_config_webhooks_with_path) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks/{path} | 
...
*OapiApi* | [**create_namespaced_build_clone**](docs/OapiApi.md#create_namespaced_build_clone) | **POST** /oapi/v1/namespaces/{namespace}/builds/{name}/clone | 
...
*OapiApi* | [**patch_namespaced_deployment_config_scale**](docs/OapiApi.md#patch_namespaced_deployment_config_scale) | **PATCH** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/scale | 
*OapiApi* | [**patch_namespaced_deployment_config_status**](docs/OapiApi.md#patch_namespaced_deployment_config_status) | **PATCH** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/status | 
...
*OapiApi* | [**patch_namespaced_route_status**](docs/OapiApi.md#patch_namespaced_route_status) | **PATCH** /oapi/v1/namespaces/{namespace}/routes/{name}/status | 
...
*OapiApi* | [**read_namespaced_build_log**](docs/OapiApi.md#read_namespaced_build_log) | **GET** /oapi/v1/namespaces/{namespace}/builds/{name}/log | 
...
*OapiApi* | [**read_namespaced_deployment_config_log**](docs/OapiApi.md#read_namespaced_deployment_config_log) | **GET** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/log | 
*OapiApi* | [**read_namespaced_deployment_config_scale**](docs/OapiApi.md#read_namespaced_deployment_config_scale) | **GET** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/scale | 
*OapiApi* | [**read_namespaced_deployment_config_status**](docs/OapiApi.md#read_namespaced_deployment_config_status) | **GET** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/status | 
...
*OapiApi* | [**read_namespaced_image_stream_secrets**](docs/OapiApi.md#read_namespaced_image_stream_secrets) | **GET** /oapi/v1/namespaces/{namespace}/imagestreams/{name}/secrets | 
...
*OapiApi* | [**read_namespaced_route_status**](docs/OapiApi.md#read_namespaced_route_status) | **GET** /oapi/v1/namespaces/{namespace}/routes/{name}/status | 
...
*OapiApi* | [**replace_namespaced_deployment_config_scale**](docs/OapiApi.md#replace_namespaced_deployment_config_scale) | **PUT** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/scale | 
