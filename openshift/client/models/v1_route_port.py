...
class V1RoutePort(object):
    ...
    def target_port(self):
        """
        Gets the target_port of this V1RoutePort.
        ...
        :return: The target_port of this V1RoutePort.
    ...
    def target_port(self, target_port):
        """
        Sets the target_port of this V1RoutePort.
        The target port on pods selected by the service this route points to. If this is a string, it will be looked up as a named port in the target endpoints port list. Required

        :param target_port: The target_port of this V1RoutePort.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1RoutePort):
            return False
