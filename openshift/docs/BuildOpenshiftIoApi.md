...
------------- | ------------- | -------------
[**get_api_group**](BuildOpenshiftIoApi.md#get_api_group) | **GET** /apis/build.openshift.io/ | 
...
api_instance = openshift.client.BuildOpenshiftIoApi(openshift.client.ApiClient(configuration))

try: 
    api_response = api_instance.get_api_group()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling BuildOpenshiftIoApi->get_api_group: %s\n" % e)
```
