...
------------- | ------------- | -------------
[**get_api_group**](NetworkOpenshiftIoApi.md#get_api_group) | **GET** /apis/network.openshift.io/ | 
...
api_instance = openshift.client.NetworkOpenshiftIoApi(openshift.client.ApiClient(configuration))

try: 
    api_response = api_instance.get_api_group()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NetworkOpenshiftIoApi->get_api_group: %s\n" % e)
```
