...
------------- | ------------- | -------------
[**connect_post_namespaced_build_config_instantiatebinary**](OapiApi.md#connect_post_namespaced_build_config_instantiatebinary) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs/{name}/instantiatebinary | 
[**connect_post_namespaced_build_config_webhooks**](OapiApi.md#connect_post_namespaced_build_config_webhooks) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks | 
[**connect_post_namespaced_build_config_webhooks_with_path**](OapiApi.md#connect_post_namespaced_build_config_webhooks_with_path) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs/{name}/webhooks/{path} | 
...
[**create_namespaced_build_clone**](OapiApi.md#create_namespaced_build_clone) | **POST** /oapi/v1/namespaces/{namespace}/builds/{name}/clone | 
[**create_namespaced_build_config**](OapiApi.md#create_namespaced_build_config) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs | 
[**create_namespaced_build_config_instantiate**](OapiApi.md#create_namespaced_build_config_instantiate) | **POST** /oapi/v1/namespaces/{namespace}/buildconfigs/{name}/instantiate | 
...
[**create_namespaced_deployment_config_instantiate**](OapiApi.md#create_namespaced_deployment_config_instantiate) | **POST** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/instantiate | 
...
[**patch_namespaced_deployment_config_scale**](OapiApi.md#patch_namespaced_deployment_config_scale) | **PATCH** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/scale | 
...
[**read_namespaced_build_log**](OapiApi.md#read_namespaced_build_log) | **GET** /oapi/v1/namespaces/{namespace}/builds/{name}/log | 
...
[**read_namespaced_deployment_config_log**](OapiApi.md#read_namespaced_deployment_config_log) | **GET** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/log | 
[**read_namespaced_deployment_config_scale**](OapiApi.md#read_namespaced_deployment_config_scale) | **GET** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/scale | 
...
[**read_namespaced_image_stream_secrets**](OapiApi.md#read_namespaced_image_stream_secrets) | **GET** /oapi/v1/namespaces/{namespace}/imagestreams/{name}/secrets | 
...
[**replace_namespaced_deployment_config_scale**](OapiApi.md#replace_namespaced_deployment_config_scale) | **PUT** /oapi/v1/namespaces/{namespace}/deploymentconfigs/{name}/scale | 
...
api_instance = openshift.client.OapiApi(openshift.client.ApiClient(configuration))
...
try: 
    ...
    print("Exception when calling OapiApi->connect_post_namespaced_build_config_instantiatebinary: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->connect_post_namespaced_build_config_webhooks: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->connect_post_namespaced_build_config_webhooks_with_path: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->create_namespaced_build_clone: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->create_namespaced_build_config_instantiate: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->create_namespaced_deployment_config_instantiate: %s\n" % e)
```
...
> V1Template create_namespaced_processed_template(namespace, body, pretty=pretty)
...
try: 
    api_response = api_instance.create_namespaced_processed_template(namespace, body, pretty=pretty)
    pprint(api_response)
except ApiException as e:
...
> V1ResourceAccessReview create_namespaced_resource_access_review(namespace, body, pretty=pretty)
...
try: 
    api_response = api_instance.create_namespaced_resource_access_review(namespace, body, pretty=pretty)
    pprint(api_response)
except ApiException as e:
...
> V1SubjectAccessReview create_namespaced_subject_access_review(namespace, body, pretty=pretty)
...
try: 
    api_response = api_instance.create_namespaced_subject_access_review(namespace, body, pretty=pretty)
    pprint(api_response)
except ApiException as e:
...
# **get_legacy_api_versions**
> V1APIVersions get_legacy_api_versions()
...
try: 
    api_response = api_instance.get_legacy_api_versions()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling OapiApi->get_legacy_api_versions: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->read_namespaced_build_log: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->read_namespaced_deployment_config_log: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->read_namespaced_deployment_config_scale: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->read_namespaced_image_stream_secrets: %s\n" % e)
```
...
try: 
    ...
    print("Exception when calling OapiApi->replace_namespaced_deployment_config_scale: %s\n" % e)
```
