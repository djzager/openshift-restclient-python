...
------------- | ------------- | -------------
[**get_api_group**](QuotaOpenshiftIoApi.md#get_api_group) | **GET** /apis/quota.openshift.io/ | 
...
api_instance = openshift.client.QuotaOpenshiftIoApi(openshift.client.ApiClient(configuration))

try: 
    api_response = api_instance.get_api_group()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling QuotaOpenshiftIoApi->get_api_group: %s\n" % e)
```
