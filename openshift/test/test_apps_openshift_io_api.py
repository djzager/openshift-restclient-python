...
from openshift.client.apis.apps_openshift_io_api import AppsOpenshiftIoApi


class TestAppsOpenshiftIoApi(unittest.TestCase):
    """ AppsOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.apps_openshift_io_api.AppsOpenshiftIoApi()
