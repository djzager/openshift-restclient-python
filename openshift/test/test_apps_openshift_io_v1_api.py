...
from openshift.client.apis.apps_openshift_io_v1_api import AppsOpenshiftIoV1Api


class TestAppsOpenshiftIoV1Api(unittest.TestCase):
    """ AppsOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.apps_openshift_io_v1_api.AppsOpenshiftIoV1Api()
