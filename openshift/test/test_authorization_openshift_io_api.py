...
from openshift.client.apis.authorization_openshift_io_api import AuthorizationOpenshiftIoApi


class TestAuthorizationOpenshiftIoApi(unittest.TestCase):
    """ AuthorizationOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.authorization_openshift_io_api.AuthorizationOpenshiftIoApi()
