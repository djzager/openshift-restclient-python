...
from openshift.client.apis.authorization_openshift_io_v1_api import AuthorizationOpenshiftIoV1Api


class TestAuthorizationOpenshiftIoV1Api(unittest.TestCase):
    """ AuthorizationOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.authorization_openshift_io_v1_api.AuthorizationOpenshiftIoV1Api()
