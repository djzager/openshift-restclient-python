...
from openshift.client.apis.build_openshift_io_api import BuildOpenshiftIoApi


class TestBuildOpenshiftIoApi(unittest.TestCase):
    """ BuildOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.build_openshift_io_api.BuildOpenshiftIoApi()
