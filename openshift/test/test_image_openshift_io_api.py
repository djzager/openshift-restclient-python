...
from openshift.client.apis.image_openshift_io_api import ImageOpenshiftIoApi


class TestImageOpenshiftIoApi(unittest.TestCase):
    """ ImageOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.image_openshift_io_api.ImageOpenshiftIoApi()
