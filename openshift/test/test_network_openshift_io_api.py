...
from openshift.client.apis.network_openshift_io_api import NetworkOpenshiftIoApi


class TestNetworkOpenshiftIoApi(unittest.TestCase):
    """ NetworkOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.network_openshift_io_api.NetworkOpenshiftIoApi()
