...
from openshift.client.apis.network_openshift_io_v1_api import NetworkOpenshiftIoV1Api


class TestNetworkOpenshiftIoV1Api(unittest.TestCase):
    """ NetworkOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.network_openshift_io_v1_api.NetworkOpenshiftIoV1Api()
