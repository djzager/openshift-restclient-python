...
from openshift.client.apis.oauth_openshift_io_api import OauthOpenshiftIoApi


class TestOauthOpenshiftIoApi(unittest.TestCase):
    """ OauthOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.oauth_openshift_io_api.OauthOpenshiftIoApi()
