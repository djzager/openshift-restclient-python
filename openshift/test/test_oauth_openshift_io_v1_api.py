...
from openshift.client.apis.oauth_openshift_io_v1_api import OauthOpenshiftIoV1Api


class TestOauthOpenshiftIoV1Api(unittest.TestCase):
    """ OauthOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.oauth_openshift_io_v1_api.OauthOpenshiftIoV1Api()
