...
from openshift.client.apis.project_openshift_io_api import ProjectOpenshiftIoApi


class TestProjectOpenshiftIoApi(unittest.TestCase):
    """ ProjectOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.project_openshift_io_api.ProjectOpenshiftIoApi()
