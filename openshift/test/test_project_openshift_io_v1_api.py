...
from openshift.client.apis.project_openshift_io_v1_api import ProjectOpenshiftIoV1Api


class TestProjectOpenshiftIoV1Api(unittest.TestCase):
    """ ProjectOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.project_openshift_io_v1_api.ProjectOpenshiftIoV1Api()
