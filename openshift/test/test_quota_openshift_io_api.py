...
from openshift.client.apis.quota_openshift_io_api import QuotaOpenshiftIoApi


class TestQuotaOpenshiftIoApi(unittest.TestCase):
    """ QuotaOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.quota_openshift_io_api.QuotaOpenshiftIoApi()
