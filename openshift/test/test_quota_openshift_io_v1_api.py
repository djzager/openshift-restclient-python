...
from openshift.client.apis.quota_openshift_io_v1_api import QuotaOpenshiftIoV1Api


class TestQuotaOpenshiftIoV1Api(unittest.TestCase):
    """ QuotaOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.quota_openshift_io_v1_api.QuotaOpenshiftIoV1Api()
