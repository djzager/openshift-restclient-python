...
from openshift.client.apis.route_openshift_io_api import RouteOpenshiftIoApi


class TestRouteOpenshiftIoApi(unittest.TestCase):
    """ RouteOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.route_openshift_io_api.RouteOpenshiftIoApi()
