...
from openshift.client.apis.route_openshift_io_v1_api import RouteOpenshiftIoV1Api


class TestRouteOpenshiftIoV1Api(unittest.TestCase):
    """ RouteOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.route_openshift_io_v1_api.RouteOpenshiftIoV1Api()
