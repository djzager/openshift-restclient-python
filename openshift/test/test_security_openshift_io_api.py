...
from openshift.client.apis.security_openshift_io_api import SecurityOpenshiftIoApi


class TestSecurityOpenshiftIoApi(unittest.TestCase):
    """ SecurityOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.security_openshift_io_api.SecurityOpenshiftIoApi()
