...
from openshift.client.apis.security_openshift_io_v1_api import SecurityOpenshiftIoV1Api


class TestSecurityOpenshiftIoV1Api(unittest.TestCase):
    """ SecurityOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.security_openshift_io_v1_api.SecurityOpenshiftIoV1Api()
