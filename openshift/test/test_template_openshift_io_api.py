...
from openshift.client.apis.template_openshift_io_api import TemplateOpenshiftIoApi


class TestTemplateOpenshiftIoApi(unittest.TestCase):
    """ TemplateOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.template_openshift_io_api.TemplateOpenshiftIoApi()
