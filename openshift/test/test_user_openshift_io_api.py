...
from openshift.client.apis.user_openshift_io_api import UserOpenshiftIoApi


class TestUserOpenshiftIoApi(unittest.TestCase):
    """ UserOpenshiftIoApi unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.user_openshift_io_api.UserOpenshiftIoApi()
