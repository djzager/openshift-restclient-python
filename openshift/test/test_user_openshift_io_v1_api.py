...
from openshift.client.apis.user_openshift_io_v1_api import UserOpenshiftIoV1Api


class TestUserOpenshiftIoV1Api(unittest.TestCase):
    """ UserOpenshiftIoV1Api unit test stubs """

    def setUp(self):
        self.api = openshift.client.apis.user_openshift_io_v1_api.UserOpenshiftIoV1Api()
