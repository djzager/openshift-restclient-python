...
class TestV1AppliedClusterResourceQuotaList(unittest.TestCase):
    """ V1AppliedClusterResourceQuotaList unit test stubs """
    ...
    def testV1AppliedClusterResourceQuotaList(self):
        """
