...
from openshift.client.models.v1_binary_build_source import V1BinaryBuildSource


class TestV1BinaryBuildSource(unittest.TestCase):
    """ V1BinaryBuildSource unit test stubs """
    ...
    def testV1BinaryBuildSource(self):
        """
