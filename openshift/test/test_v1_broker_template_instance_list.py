...
from openshift.client.models.v1_broker_template_instance_list import V1BrokerTemplateInstanceList


class TestV1BrokerTemplateInstanceList(unittest.TestCase):
    """ V1BrokerTemplateInstanceList unit test stubs """
    ...
    def testV1BrokerTemplateInstanceList(self):
        """
