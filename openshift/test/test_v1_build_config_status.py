...
from openshift.client.models.v1_build_config_status import V1BuildConfigStatus


class TestV1BuildConfigStatus(unittest.TestCase):
    """ V1BuildConfigStatus unit test stubs """
    ...
    def testV1BuildConfigStatus(self):
        """
