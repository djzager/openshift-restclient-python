...
from openshift.client.models.v1_build_list import V1BuildList


class TestV1BuildList(unittest.TestCase):
    """ V1BuildList unit test stubs """
    ...
    def testV1BuildList(self):
        """
        Test V1BuildList
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_build_list.V1BuildList()
        pass
