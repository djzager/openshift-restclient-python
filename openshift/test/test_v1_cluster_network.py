...
from openshift.client.models.v1_cluster_network import V1ClusterNetwork


class TestV1ClusterNetwork(unittest.TestCase):
    """ V1ClusterNetwork unit test stubs """
