...
from openshift.client.models.v1_cluster_network_entry import V1ClusterNetworkEntry


class TestV1ClusterNetworkEntry(unittest.TestCase):
    """ V1ClusterNetworkEntry unit test stubs """
    ...
    def testV1ClusterNetworkEntry(self):
        """
        Test V1ClusterNetworkEntry
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_cluster_network_entry.V1ClusterNetworkEntry()
        pass
