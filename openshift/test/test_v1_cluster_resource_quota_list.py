...
from openshift.client.models.v1_cluster_resource_quota_list import V1ClusterResourceQuotaList


class TestV1ClusterResourceQuotaList(unittest.TestCase):
    """ V1ClusterResourceQuotaList unit test stubs """
    ...
    def testV1ClusterResourceQuotaList(self):
        """
        Test V1ClusterResourceQuotaList
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_cluster_resource_quota_list.V1ClusterResourceQuotaList()
        pass
