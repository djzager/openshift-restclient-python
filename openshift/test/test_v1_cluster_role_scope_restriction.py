...
from openshift.client.models.v1_cluster_role_scope_restriction import V1ClusterRoleScopeRestriction


class TestV1ClusterRoleScopeRestriction(unittest.TestCase):
    """ V1ClusterRoleScopeRestriction unit test stubs """
    ...
    def testV1ClusterRoleScopeRestriction(self):
        """
