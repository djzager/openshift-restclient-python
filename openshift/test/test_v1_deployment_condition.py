...
from openshift.client.models.v1_deployment_condition import V1DeploymentCondition
...
class TestV1DeploymentCondition(unittest.TestCase):
    ...
    def testV1DeploymentCondition(self):
        ...
        #model = openshift.client.models.v1_deployment_condition.V1DeploymentCondition()
        pass
