...
from openshift.client.models.v1_deployment_config_list import V1DeploymentConfigList


class TestV1DeploymentConfigList(unittest.TestCase):
    """ V1DeploymentConfigList unit test stubs """
    ...
    def testV1DeploymentConfigList(self):
        """
