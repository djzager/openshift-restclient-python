...
from openshift.client.models.v1_deployment_config_rollback import V1DeploymentConfigRollback


class TestV1DeploymentConfigRollback(unittest.TestCase):
    """ V1DeploymentConfigRollback unit test stubs """
    ...
    def testV1DeploymentConfigRollback(self):
        """
