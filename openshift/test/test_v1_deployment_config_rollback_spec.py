...
from openshift.client.models.v1_deployment_config_rollback_spec import V1DeploymentConfigRollbackSpec
...
class TestV1DeploymentConfigRollbackSpec(unittest.TestCase):
    ...
    def testV1DeploymentConfigRollbackSpec(self):
        ...
        #model = openshift.client.models.v1_deployment_config_rollback_spec.V1DeploymentConfigRollbackSpec()
        pass
