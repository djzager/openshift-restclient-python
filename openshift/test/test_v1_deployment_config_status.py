...
from openshift.client.models.v1_deployment_config_status import V1DeploymentConfigStatus


class TestV1DeploymentConfigStatus(unittest.TestCase):
    """ V1DeploymentConfigStatus unit test stubs """
    ...
    def testV1DeploymentConfigStatus(self):
        """
