...
from openshift.client.models.v1_deployment_details import V1DeploymentDetails


class TestV1DeploymentDetails(unittest.TestCase):
    """ V1DeploymentDetails unit test stubs """
    ...
    def testV1DeploymentDetails(self):
        """
        Test V1DeploymentDetails
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_deployment_details.V1DeploymentDetails()
        pass
