...
from openshift.client.models.v1_deployment_log import V1DeploymentLog


class TestV1DeploymentLog(unittest.TestCase):
    """ V1DeploymentLog unit test stubs """
    ...
    def testV1DeploymentLog(self):
        """
        Test V1DeploymentLog
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_deployment_log.V1DeploymentLog()
        pass
