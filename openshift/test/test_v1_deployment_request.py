...
from openshift.client.models.v1_deployment_request import V1DeploymentRequest


class TestV1DeploymentRequest(unittest.TestCase):
    """ V1DeploymentRequest unit test stubs """
    ...
    def testV1DeploymentRequest(self):
        """
