...
from openshift.client.models.v1_deployment_trigger_image_change_params import V1DeploymentTriggerImageChangeParams


class TestV1DeploymentTriggerImageChangeParams(unittest.TestCase):
    """ V1DeploymentTriggerImageChangeParams unit test stubs """
    ...
    def testV1DeploymentTriggerImageChangeParams(self):
        """
