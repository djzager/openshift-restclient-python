...
from openshift.client.models.v1_deployment_trigger_policy import V1DeploymentTriggerPolicy


class TestV1DeploymentTriggerPolicy(unittest.TestCase):
    """ V1DeploymentTriggerPolicy unit test stubs """
    ...
    def testV1DeploymentTriggerPolicy(self):
        """
