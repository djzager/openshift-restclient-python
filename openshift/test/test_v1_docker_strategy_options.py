...
from openshift.client.models.v1_docker_strategy_options import V1DockerStrategyOptions


class TestV1DockerStrategyOptions(unittest.TestCase):
    """ V1DockerStrategyOptions unit test stubs """
    ...
    def testV1DockerStrategyOptions(self):
        """
