...
from openshift.client.models.v1_egress_network_policy import V1EgressNetworkPolicy


class TestV1EgressNetworkPolicy(unittest.TestCase):
    """ V1EgressNetworkPolicy unit test stubs """
    ...
    def testV1EgressNetworkPolicy(self):
        """
        Test V1EgressNetworkPolicy
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_egress_network_policy.V1EgressNetworkPolicy()
        pass
