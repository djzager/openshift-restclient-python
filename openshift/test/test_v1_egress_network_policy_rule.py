...
from openshift.client.models.v1_egress_network_policy_rule import V1EgressNetworkPolicyRule


class TestV1EgressNetworkPolicyRule(unittest.TestCase):
    """ V1EgressNetworkPolicyRule unit test stubs """
    ...
    def testV1EgressNetworkPolicyRule(self):
        """
        Test V1EgressNetworkPolicyRule
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_egress_network_policy_rule.V1EgressNetworkPolicyRule()
        pass
