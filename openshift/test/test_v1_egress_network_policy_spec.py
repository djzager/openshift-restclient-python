...
from openshift.client.models.v1_egress_network_policy_spec import V1EgressNetworkPolicySpec


class TestV1EgressNetworkPolicySpec(unittest.TestCase):
    """ V1EgressNetworkPolicySpec unit test stubs """
    ...
    def testV1EgressNetworkPolicySpec(self):
        """
