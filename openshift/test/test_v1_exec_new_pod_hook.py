...
from openshift.client.models.v1_exec_new_pod_hook import V1ExecNewPodHook


class TestV1ExecNewPodHook(unittest.TestCase):
    """ V1ExecNewPodHook unit test stubs """
