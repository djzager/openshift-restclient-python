...
from openshift.client.models.v1_fs_group_strategy_options import V1FSGroupStrategyOptions


class TestV1FSGroupStrategyOptions(unittest.TestCase):
    """ V1FSGroupStrategyOptions unit test stubs """
    ...
    def testV1FSGroupStrategyOptions(self):
        """
