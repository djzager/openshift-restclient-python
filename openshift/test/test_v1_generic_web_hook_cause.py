...
from openshift.client.models.v1_generic_web_hook_cause import V1GenericWebHookCause


class TestV1GenericWebHookCause(unittest.TestCase):
    """ V1GenericWebHookCause unit test stubs """
    ...
    def testV1GenericWebHookCause(self):
        """
