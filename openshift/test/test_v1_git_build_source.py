...
from openshift.client.models.v1_git_build_source import V1GitBuildSource


class TestV1GitBuildSource(unittest.TestCase):
    """ V1GitBuildSource unit test stubs """
