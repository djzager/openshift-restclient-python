...
from openshift.client.models.v1_git_hub_web_hook_cause import V1GitHubWebHookCause


class TestV1GitHubWebHookCause(unittest.TestCase):
    """ V1GitHubWebHookCause unit test stubs """
    ...
    def testV1GitHubWebHookCause(self):
        """
