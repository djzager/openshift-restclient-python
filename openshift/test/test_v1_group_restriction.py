...
from openshift.client.models.v1_group_restriction import V1GroupRestriction


class TestV1GroupRestriction(unittest.TestCase):
    """ V1GroupRestriction unit test stubs """
    ...
    def testV1GroupRestriction(self):
        """
