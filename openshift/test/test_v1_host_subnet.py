...
from openshift.client.models.v1_host_subnet import V1HostSubnet


class TestV1HostSubnet(unittest.TestCase):
    """ V1HostSubnet unit test stubs """
