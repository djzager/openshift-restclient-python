...
from openshift.client.models.v1_image_change_cause import V1ImageChangeCause


class TestV1ImageChangeCause(unittest.TestCase):
    """ V1ImageChangeCause unit test stubs """
    ...
    def testV1ImageChangeCause(self):
        """
