...
from openshift.client.models.v1_image_import_spec import V1ImageImportSpec


class TestV1ImageImportSpec(unittest.TestCase):
    """ V1ImageImportSpec unit test stubs """
    ...
    def testV1ImageImportSpec(self):
        """
        Test V1ImageImportSpec
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_image_import_spec.V1ImageImportSpec()
        pass
