...
from openshift.client.models.v1_image_import_status import V1ImageImportStatus


class TestV1ImageImportStatus(unittest.TestCase):
    """ V1ImageImportStatus unit test stubs """
    ...
    def testV1ImageImportStatus(self):
        """
