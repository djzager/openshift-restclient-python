...
from openshift.client.models.v1_image_layer import V1ImageLayer


class TestV1ImageLayer(unittest.TestCase):
    """ V1ImageLayer unit test stubs """
