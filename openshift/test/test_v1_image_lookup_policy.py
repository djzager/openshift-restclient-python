...
from openshift.client.models.v1_image_lookup_policy import V1ImageLookupPolicy


class TestV1ImageLookupPolicy(unittest.TestCase):
    """ V1ImageLookupPolicy unit test stubs """
    ...
    def testV1ImageLookupPolicy(self):
        """
