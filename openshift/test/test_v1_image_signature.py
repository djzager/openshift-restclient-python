...
from openshift.client.models.v1_image_signature import V1ImageSignature


class TestV1ImageSignature(unittest.TestCase):
    """ V1ImageSignature unit test stubs """
    ...
    def testV1ImageSignature(self):
        """
        Test V1ImageSignature
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_image_signature.V1ImageSignature()
        pass
