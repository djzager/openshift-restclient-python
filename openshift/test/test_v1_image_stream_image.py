...
from openshift.client.models.v1_image_stream_image import V1ImageStreamImage


class TestV1ImageStreamImage(unittest.TestCase):
    """ V1ImageStreamImage unit test stubs """
    ...
    def testV1ImageStreamImage(self):
        """
        Test V1ImageStreamImage
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_image_stream_image.V1ImageStreamImage()
        pass
