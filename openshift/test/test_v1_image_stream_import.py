...
from openshift.client.models.v1_image_stream_import import V1ImageStreamImport


class TestV1ImageStreamImport(unittest.TestCase):
    """ V1ImageStreamImport unit test stubs """
    ...
    def testV1ImageStreamImport(self):
        """
        Test V1ImageStreamImport
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_image_stream_import.V1ImageStreamImport()
        pass
