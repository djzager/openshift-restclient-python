...
from openshift.client.models.v1_image_stream_import_spec import V1ImageStreamImportSpec


class TestV1ImageStreamImportSpec(unittest.TestCase):
    """ V1ImageStreamImportSpec unit test stubs """
    ...
    def testV1ImageStreamImportSpec(self):
        """
        Test V1ImageStreamImportSpec
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_image_stream_import_spec.V1ImageStreamImportSpec()
        pass
