...
from openshift.client.models.v1_image_stream_import_status import V1ImageStreamImportStatus


class TestV1ImageStreamImportStatus(unittest.TestCase):
    """ V1ImageStreamImportStatus unit test stubs """
    ...
    def testV1ImageStreamImportStatus(self):
        """
        Test V1ImageStreamImportStatus
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_image_stream_import_status.V1ImageStreamImportStatus()
        pass
