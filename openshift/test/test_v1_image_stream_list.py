...
from openshift.client.models.v1_image_stream_list import V1ImageStreamList


class TestV1ImageStreamList(unittest.TestCase):
    """ V1ImageStreamList unit test stubs """
    ...
    def testV1ImageStreamList(self):
        """
