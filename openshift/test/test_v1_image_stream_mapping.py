...
from openshift.client.models.v1_image_stream_mapping import V1ImageStreamMapping


class TestV1ImageStreamMapping(unittest.TestCase):
    """ V1ImageStreamMapping unit test stubs """
    ...
    def testV1ImageStreamMapping(self):
        """
