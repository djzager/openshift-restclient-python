...
from openshift.client.models.v1_image_stream_spec import V1ImageStreamSpec


class TestV1ImageStreamSpec(unittest.TestCase):
    """ V1ImageStreamSpec unit test stubs """
    ...
    def testV1ImageStreamSpec(self):
        """
        Test V1ImageStreamSpec
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_image_stream_spec.V1ImageStreamSpec()
        pass
