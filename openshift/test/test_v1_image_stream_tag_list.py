...
from openshift.client.models.v1_image_stream_tag_list import V1ImageStreamTagList


class TestV1ImageStreamTagList(unittest.TestCase):
    """ V1ImageStreamTagList unit test stubs """
    ...
    def testV1ImageStreamTagList(self):
        """
