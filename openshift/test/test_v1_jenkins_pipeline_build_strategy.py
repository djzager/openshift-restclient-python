...
from openshift.client.models.v1_jenkins_pipeline_build_strategy import V1JenkinsPipelineBuildStrategy


class TestV1JenkinsPipelineBuildStrategy(unittest.TestCase):
    """ V1JenkinsPipelineBuildStrategy unit test stubs """
    ...
    def testV1JenkinsPipelineBuildStrategy(self):
        """
