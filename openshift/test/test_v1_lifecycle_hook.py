...
from openshift.client.models.v1_lifecycle_hook import V1LifecycleHook


class TestV1LifecycleHook(unittest.TestCase):
    """ V1LifecycleHook unit test stubs """
    ...
    def testV1LifecycleHook(self):
        """
        Test V1LifecycleHook
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_lifecycle_hook.V1LifecycleHook()
        pass
