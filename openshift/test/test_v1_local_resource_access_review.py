...
from openshift.client.models.v1_local_resource_access_review import V1LocalResourceAccessReview


class TestV1LocalResourceAccessReview(unittest.TestCase):
    """ V1LocalResourceAccessReview unit test stubs """
    ...
    def testV1LocalResourceAccessReview(self):
        """
