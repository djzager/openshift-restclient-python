...
from openshift.client.models.v1_named_tag_event_list import V1NamedTagEventList


class TestV1NamedTagEventList(unittest.TestCase):
    """ V1NamedTagEventList unit test stubs """
    ...
    def testV1NamedTagEventList(self):
        """
