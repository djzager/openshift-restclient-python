...
from openshift.client.models.v1_net_namespace_list import V1NetNamespaceList


class TestV1NetNamespaceList(unittest.TestCase):
    """ V1NetNamespaceList unit test stubs """
    ...
    def testV1NetNamespaceList(self):
        """
