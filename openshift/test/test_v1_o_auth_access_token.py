...
from openshift.client.models.v1_o_auth_access_token import V1OAuthAccessToken


class TestV1OAuthAccessToken(unittest.TestCase):
    """ V1OAuthAccessToken unit test stubs """
    ...
    def testV1OAuthAccessToken(self):
        """
