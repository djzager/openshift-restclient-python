...
from openshift.client.models.v1_o_auth_access_token_list import V1OAuthAccessTokenList


class TestV1OAuthAccessTokenList(unittest.TestCase):
    """ V1OAuthAccessTokenList unit test stubs """
    ...
    def testV1OAuthAccessTokenList(self):
        """
        Test V1OAuthAccessTokenList
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_o_auth_access_token_list.V1OAuthAccessTokenList()
        pass
