...
from openshift.client.models.v1_o_auth_authorize_token_list import V1OAuthAuthorizeTokenList


class TestV1OAuthAuthorizeTokenList(unittest.TestCase):
    """ V1OAuthAuthorizeTokenList unit test stubs """
    ...
    def testV1OAuthAuthorizeTokenList(self):
        """
