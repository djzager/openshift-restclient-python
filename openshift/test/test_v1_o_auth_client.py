...
from openshift.client.models.v1_o_auth_client import V1OAuthClient


class TestV1OAuthClient(unittest.TestCase):
    """ V1OAuthClient unit test stubs """
