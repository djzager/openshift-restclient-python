...
from openshift.client.models.v1_pod_security_policy_self_subject_review import V1PodSecurityPolicySelfSubjectReview


class TestV1PodSecurityPolicySelfSubjectReview(unittest.TestCase):
    """ V1PodSecurityPolicySelfSubjectReview unit test stubs """
    ...
    def testV1PodSecurityPolicySelfSubjectReview(self):
        """
        Test V1PodSecurityPolicySelfSubjectReview
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_pod_security_policy_self_subject_review.V1PodSecurityPolicySelfSubjectReview()
        pass
