...
from openshift.client.models.v1_pod_security_policy_self_subject_review_spec import V1PodSecurityPolicySelfSubjectReviewSpec


class TestV1PodSecurityPolicySelfSubjectReviewSpec(unittest.TestCase):
    """ V1PodSecurityPolicySelfSubjectReviewSpec unit test stubs """
    ...
    def testV1PodSecurityPolicySelfSubjectReviewSpec(self):
        """
