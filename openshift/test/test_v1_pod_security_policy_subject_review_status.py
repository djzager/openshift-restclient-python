...
class TestV1PodSecurityPolicySubjectReviewStatus(unittest.TestCase):
    """ V1PodSecurityPolicySubjectReviewStatus unit test stubs """
    ...
    def testV1PodSecurityPolicySubjectReviewStatus(self):
        """
        Test V1PodSecurityPolicySubjectReviewStatus
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_pod_security_policy_subject_review_status.V1PodSecurityPolicySubjectReviewStatus()
        pass
