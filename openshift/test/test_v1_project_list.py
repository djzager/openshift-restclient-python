...
from openshift.client.models.v1_project_list import V1ProjectList


class TestV1ProjectList(unittest.TestCase):
    """ V1ProjectList unit test stubs """
    ...
    def testV1ProjectList(self):
        """
        Test V1ProjectList
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_project_list.V1ProjectList()
        pass
