...
from openshift.client.models.v1_project_request import V1ProjectRequest


class TestV1ProjectRequest(unittest.TestCase):
    """ V1ProjectRequest unit test stubs """
