...
from openshift.client.models.v1_recreate_deployment_strategy_params import V1RecreateDeploymentStrategyParams


class TestV1RecreateDeploymentStrategyParams(unittest.TestCase):
    """ V1RecreateDeploymentStrategyParams unit test stubs """
    ...
    def testV1RecreateDeploymentStrategyParams(self):
        """
