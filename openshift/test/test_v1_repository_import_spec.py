...
from openshift.client.models.v1_repository_import_spec import V1RepositoryImportSpec


class TestV1RepositoryImportSpec(unittest.TestCase):
    """ V1RepositoryImportSpec unit test stubs """
    ...
    def testV1RepositoryImportSpec(self):
        """
        Test V1RepositoryImportSpec
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_repository_import_spec.V1RepositoryImportSpec()
        pass
