...
from openshift.client.models.v1_resource_quota_status_by_namespace import V1ResourceQuotaStatusByNamespace


class TestV1ResourceQuotaStatusByNamespace(unittest.TestCase):
    """ V1ResourceQuotaStatusByNamespace unit test stubs """
    ...
    def testV1ResourceQuotaStatusByNamespace(self):
        """
