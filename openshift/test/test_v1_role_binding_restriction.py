...
from openshift.client.models.v1_role_binding_restriction import V1RoleBindingRestriction


class TestV1RoleBindingRestriction(unittest.TestCase):
    """ V1RoleBindingRestriction unit test stubs """
    ...
    def testV1RoleBindingRestriction(self):
        """
        Test V1RoleBindingRestriction
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_role_binding_restriction.V1RoleBindingRestriction()
        pass
