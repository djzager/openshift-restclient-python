...
from openshift.client.models.v1_role_binding_restriction_spec import V1RoleBindingRestrictionSpec


class TestV1RoleBindingRestrictionSpec(unittest.TestCase):
    """ V1RoleBindingRestrictionSpec unit test stubs """
    ...
    def testV1RoleBindingRestrictionSpec(self):
        """
