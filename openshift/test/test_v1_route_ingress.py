...
from openshift.client.models.v1_route_ingress import V1RouteIngress


class TestV1RouteIngress(unittest.TestCase):
    """ V1RouteIngress unit test stubs """
