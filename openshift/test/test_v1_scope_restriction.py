...
from openshift.client.models.v1_scope_restriction import V1ScopeRestriction


class TestV1ScopeRestriction(unittest.TestCase):
    """ V1ScopeRestriction unit test stubs """
    ...
    def testV1ScopeRestriction(self):
        """
