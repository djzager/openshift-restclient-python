...
from openshift.client.models.v1_secret_build_source import V1SecretBuildSource


class TestV1SecretBuildSource(unittest.TestCase):
    """ V1SecretBuildSource unit test stubs """
    ...
    def testV1SecretBuildSource(self):
        """
