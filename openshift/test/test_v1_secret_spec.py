...
from openshift.client.models.v1_secret_spec import V1SecretSpec


class TestV1SecretSpec(unittest.TestCase):
    """ V1SecretSpec unit test stubs """
