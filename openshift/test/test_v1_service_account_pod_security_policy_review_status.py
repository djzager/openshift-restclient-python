...
from openshift.client.models.v1_service_account_pod_security_policy_review_status import V1ServiceAccountPodSecurityPolicyReviewStatus


class TestV1ServiceAccountPodSecurityPolicyReviewStatus(unittest.TestCase):
    """ V1ServiceAccountPodSecurityPolicyReviewStatus unit test stubs """
    ...
    def testV1ServiceAccountPodSecurityPolicyReviewStatus(self):
        """
