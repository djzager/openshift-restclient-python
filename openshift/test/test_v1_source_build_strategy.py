...
from openshift.client.models.v1_source_build_strategy import V1SourceBuildStrategy


class TestV1SourceBuildStrategy(unittest.TestCase):
    """ V1SourceBuildStrategy unit test stubs """
    ...
    def testV1SourceBuildStrategy(self):
        """
        Test V1SourceBuildStrategy
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_source_build_strategy.V1SourceBuildStrategy()
        pass
