...
from openshift.client.models.v1_source_strategy_options import V1SourceStrategyOptions


class TestV1SourceStrategyOptions(unittest.TestCase):
    """ V1SourceStrategyOptions unit test stubs """
    ...
    def testV1SourceStrategyOptions(self):
        """
