...
from openshift.client.models.v1_subject_rules_review import V1SubjectRulesReview


class TestV1SubjectRulesReview(unittest.TestCase):
    """ V1SubjectRulesReview unit test stubs """
    ...
    def testV1SubjectRulesReview(self):
        """
