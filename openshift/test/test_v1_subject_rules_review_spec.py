...
from openshift.client.models.v1_subject_rules_review_spec import V1SubjectRulesReviewSpec
...
class TestV1SubjectRulesReviewSpec(unittest.TestCase):
    ...
    def testV1SubjectRulesReviewSpec(self):
        ...
        #model = openshift.client.models.v1_subject_rules_review_spec.V1SubjectRulesReviewSpec()
        pass
