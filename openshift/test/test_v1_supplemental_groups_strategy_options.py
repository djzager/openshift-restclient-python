...
from openshift.client.models.v1_supplemental_groups_strategy_options import V1SupplementalGroupsStrategyOptions


class TestV1SupplementalGroupsStrategyOptions(unittest.TestCase):
    """ V1SupplementalGroupsStrategyOptions unit test stubs """
    ...
    def testV1SupplementalGroupsStrategyOptions(self):
        """
