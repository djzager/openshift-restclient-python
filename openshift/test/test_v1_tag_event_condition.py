...
from openshift.client.models.v1_tag_event_condition import V1TagEventCondition


class TestV1TagEventCondition(unittest.TestCase):
    """ V1TagEventCondition unit test stubs """
    ...
    def testV1TagEventCondition(self):
        """
