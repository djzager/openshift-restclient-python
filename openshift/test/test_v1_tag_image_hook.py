...
from openshift.client.models.v1_tag_image_hook import V1TagImageHook


class TestV1TagImageHook(unittest.TestCase):
    """ V1TagImageHook unit test stubs """
    ...
    def testV1TagImageHook(self):
        """
        Test V1TagImageHook
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_tag_image_hook.V1TagImageHook()
        pass
