...
from openshift.client.models.v1_tag_import_policy import V1TagImportPolicy


class TestV1TagImportPolicy(unittest.TestCase):
    """ V1TagImportPolicy unit test stubs """
    ...
    def testV1TagImportPolicy(self):
        """
