...
from openshift.client.models.v1_tag_reference_policy import V1TagReferencePolicy


class TestV1TagReferencePolicy(unittest.TestCase):
    """ V1TagReferencePolicy unit test stubs """
    ...
    def testV1TagReferencePolicy(self):
        """
