...
from openshift.client.models.v1_template_instance_condition import V1TemplateInstanceCondition


class TestV1TemplateInstanceCondition(unittest.TestCase):
    """ V1TemplateInstanceCondition unit test stubs """
    ...
    def testV1TemplateInstanceCondition(self):
        """
