...
from openshift.client.models.v1_template_instance_list import V1TemplateInstanceList


class TestV1TemplateInstanceList(unittest.TestCase):
    """ V1TemplateInstanceList unit test stubs """
    ...
    def testV1TemplateInstanceList(self):
        """
