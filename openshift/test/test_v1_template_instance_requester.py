...
from openshift.client.models.v1_template_instance_requester import V1TemplateInstanceRequester


class TestV1TemplateInstanceRequester(unittest.TestCase):
    """ V1TemplateInstanceRequester unit test stubs """
    ...
    def testV1TemplateInstanceRequester(self):
        """
