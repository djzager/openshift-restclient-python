...
from openshift.client.models.v1_template_instance_spec import V1TemplateInstanceSpec


class TestV1TemplateInstanceSpec(unittest.TestCase):
    """ V1TemplateInstanceSpec unit test stubs """
    ...
    def testV1TemplateInstanceSpec(self):
        """
        Test V1TemplateInstanceSpec
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_template_instance_spec.V1TemplateInstanceSpec()
        pass
