...
from openshift.client.models.v1_template_instance_status import V1TemplateInstanceStatus


class TestV1TemplateInstanceStatus(unittest.TestCase):
    """ V1TemplateInstanceStatus unit test stubs """
    ...
    def testV1TemplateInstanceStatus(self):
        """
