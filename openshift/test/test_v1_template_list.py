...
from openshift.client.models.v1_template_list import V1TemplateList


class TestV1TemplateList(unittest.TestCase):
    """ V1TemplateList unit test stubs """
    ...
    def testV1TemplateList(self):
        """
        Test V1TemplateList
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_template_list.V1TemplateList()
        pass
