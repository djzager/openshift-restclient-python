...
from openshift.client.models.v1_web_hook_trigger import V1WebHookTrigger


class TestV1WebHookTrigger(unittest.TestCase):
    """ V1WebHookTrigger unit test stubs """
